...
<div class="container">
    ...
    <table>
        ...
        <% 
        List<AddCourseModel> list = (List) request.getAttribute("course");
        for (AddCourseModel model : list) {
        %>
        <tr>
...
<script src="JAVASCRIPT/ADMIN/ViewCourse/ViewCourse.js"></script>
<script src="JAVASCRIPT/ADMIN/ViewCourse/ViewCourse1.js."></script>
</body>
</html>